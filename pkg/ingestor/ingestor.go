...
func Ingest(
	...
	ingestorFunc := GetIngestor(ctx, scanForVulns, scanForLicense, scanForDepsDev)
...
func GetIngestor(ctx context.Context, scanForVulns bool, scanForLicense bool, scanForDepsDev bool) func(processor.DocumentTree) ([]assembler.IngestPredicates, []*parser_common.IdentifierStrings, error) {
	return func(doc processor.DocumentTree) ([]assembler.IngestPredicates, []*parser_common.IdentifierStrings, error) {
		return parser.ParseDocumentTree(ctx, doc, scanForVulns, scanForLicense, scanForDepsDev)
	}
}
