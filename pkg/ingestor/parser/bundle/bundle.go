...
// NewBundleParser initializes the bundleParser
func NewBundleParser() common.DocumentParser {
	return &bundleParser{
		identities: []common.TrustInformation{},
	}
}

// initializeBundleParser clears out all values for the next iteration
func (d *bundleParser) initializeBundleParser() {
	d.doc = nil
	d.identities = make([]common.TrustInformation, 0)
}

// Parse breaks out the document into the graph components
func (d *bundleParser) Parse(ctx context.Context, doc *processor.Document) error {
	d.initializeBundleParser()
	d.doc = doc
...
func (d *bundleParser) getIdentity(ctx context.Context) error {
	...
	_, err := verifier.VerifyIdentity(ctx, d.doc)
	if err != nil {
...
func (d *bundleParser) GetIdentities(ctx context.Context) []common.TrustInformation {
	return []common.TrustInformation{}
	//return d.identities
}

func (d *bundleParser) GetIdentifiers(ctx context.Context) (*common.IdentifierStrings, error) {
...
func (d *bundleParser) GetPredicates(ctx context.Context) *assembler.IngestPredicates {
