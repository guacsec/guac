...
func (c *Client) Use(hooks ...Hook) {
	for _, n := range []interface{ Use(...Hook) }{
		...
		c.PackageNamespace, c.PackageNode, c.PackageVersion,
	} {
		n.Use(hooks...)
	}
}
...
type (
	hooks struct {
		...
		PackageNamespace, PackageNode, PackageVersion []ent.Hook
	}
	inters struct {
		Artifact, BuilderNode, IsDependency, IsOccurrence, PackageName,
		PackageNamespace, PackageNode, PackageVersion []ent.Interceptor
	}
)
