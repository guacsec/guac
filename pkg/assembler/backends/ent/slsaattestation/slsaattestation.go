...
const (
	...
	// BuiltFromTable is the table that holds the built_from relation/edge.
	BuiltFromTable = "artifacts"
...
// ByBuiltByCount orders the results by built_by count.
func ByBuiltByCount(opts ...sql.OrderTermOption) OrderOption {
	return func(s *sql.Selector) {
		sqlgraph.OrderByNeighborsCount(s, newBuiltByStep(), opts...)
	}
}

// ByBuiltBy orders the results by built_by terms.
func ByBuiltBy(term sql.OrderTerm, terms ...sql.OrderTerm) OrderOption {
	return func(s *sql.Selector) {
		sqlgraph.OrderByNeighborTerms(s, newBuiltByStep(), append([]sql.OrderTerm{term}, terms...)...)
	}
}
