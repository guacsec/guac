...
type SourceNameEdges struct {
	...
	Occurrences []*OccurrenceSubject `json:"occurrences,omitempty"`
...
func (e SourceNameEdges) OccurrencesOrErr() ([]*OccurrenceSubject, error) {
	if e.loadedTypes[1] {
...
func (sn *SourceName) QueryOccurrences() *OccurrenceSubjectQuery {
