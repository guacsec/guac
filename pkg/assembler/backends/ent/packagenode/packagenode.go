...
const (
	// Label holds the string label denoting the packagenode type in the database.
	Label = "package_node"
	...
	// Table holds the table name of the packagenode in the database.
	Table = "package_nodes"
...
// Columns holds all SQL columns for packagenode fields.
var Columns = []string{
	FieldID,
	FieldType,
}
...
// OrderOption defines the ordering options for the PackageNode queries.
