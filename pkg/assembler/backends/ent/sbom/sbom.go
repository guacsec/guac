...
const (
	// Label holds the string label denoting the sbom type in the database.
	Label = "sbom"
	...
	// Table holds the table name of the sbom in the database.
	Table = "sbo_ms"
...
// Columns holds all SQL columns for sbom fields.
var Columns = []string{
	FieldID,
	FieldPackageID,
	FieldArtifactID,
...
// OrderOption defines the ordering options for the SBOM queries.
