...
func (ec *executionContext) _IsOccurrence_package(ctx context.Context, field graphql.CollectedField, obj *model.IsOccurrence) (ret graphql.Marshaler) {
	fc, err := ec.fieldContext_IsOccurrence_package(ctx, field)
	if err != nil {
		return graphql.Null
	}
	ctx = graphql.WithFieldContext(ctx, fc)
...
func (ec *executionContext) fieldContext_IsOccurrence_package(ctx context.Context, field graphql.CollectedField) (fc *graphql.FieldContext, err error) {
	fc = &graphql.FieldContext{
		Object:     "IsOccurrence",
		Field:      field,
		IsMethod:   false,
...
func (ec *executionContext) _IsOccurrence_source(ctx context.Context, field graphql.CollectedField, obj *model.IsOccurrence) (ret graphql.Marshaler) {
	fc, err := ec.fieldContext_IsOccurrence_source(ctx, field)
	if err != nil {
		return graphql.Null
	}
	ctx = graphql.WithFieldContext(ctx, fc)
...
func (ec *executionContext) fieldContext_IsOccurrence_source(ctx context.Context, field graphql.CollectedField) (fc *graphql.FieldContext, err error) {
	fc = &graphql.FieldContext{
		Object:     "IsOccurrence",
		Field:      field,
		IsMethod:   false,
...
func (ec *executionContext) _IsOccurrence(ctx context.Context, sel ast.SelectionSet, obj *model.IsOccurrence) graphql.Marshaler {
	...
	for i, field := range fields {
		...
		case "package":
			...
			out.Values[i] = ec._IsOccurrence_package(ctx, field, obj)

		case "source":

			out.Values[i] = ec._IsOccurrence_source(ctx, field, obj)
