...
func (ec *executionContext) unmarshalInputCertifyPkgSpec(ctx context.Context, obj interface{}) (model.CertifyPkgSpec, error) {
	...
	for _, k := range fieldsInOrder {
		...
		case "packages":
			...
			it.Packages, err = ec.unmarshalOPkgSpec2ᚕᚖgithubᚗcomᚋguacsecᚋguacᚋpkgᚋassemblerᚋgraphqlᚋmodelᚐPkgSpec(ctx, v)
			if err != nil {
				return it, err
			}
		case "justification":
...
func (ec *executionContext) marshalOCertifyPkg2ᚕᚖgithubᚗcomᚋguacsecᚋguacᚋpkgᚋassemblerᚋgraphqlᚋmodelᚐCertifyPkg(ctx context.Context, sel ast.SelectionSet, v []*model.CertifyPkg) graphql.Marshaler {
	if v == nil {
		return graphql.Null
	}
	ret := make(graphql.Array, len(v))
	...
	for i := range v {
		...
		f := func(i int) {
			...
			ret[i] = ec.marshalOCertifyPkg2ᚖgithubᚗcomᚋguacsecᚋguacᚋpkgᚋassemblerᚋgraphqlᚋmodelᚐCertifyPkg(ctx, sel, v[i])
		}
		if isLen1 {
			f(i)
		} else {
...
func (ec *executionContext) marshalOCertifyPkg2ᚖgithubᚗcomᚋguacsecᚋguacᚋpkgᚋassemblerᚋgraphqlᚋmodelᚐCertifyPkg(ctx context.Context, sel ast.SelectionSet, v *model.CertifyPkg) graphql.Marshaler {
	if v == nil {
		return graphql.Null
	}
	return ec._CertifyPkg(ctx, sel, v)
