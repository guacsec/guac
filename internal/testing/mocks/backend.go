...
func (m *MockBackend) IngestHasSBOMIDs(ctx context.Context, subjects model.PackageOrArtifactInputs, hasSBOMs []*model.HasSBOMInputSpec) ([]string, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "IngestHasSBOMIDs", ctx, subjects, hasSBOMs)
	ret0, _ := ret[0].([]string)
	ret1, _ := ret[1].(error)
	return ret0, ret1
}
...
func (mr *MockBackendMockRecorder) IngestHasSBOMIDs(ctx, subjects, hasSBOMs interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "IngestHasSBOMIDs", reflect.TypeOf((*MockBackend)(nil).IngestHasSBOMIDs), ctx, subjects, hasSBOMs)
}
...
func (m *MockBackend) IngestHasSbomID(ctx context.Context, subject model.PackageOrArtifactInput, hasSbom model.HasSBOMInputSpec) (string, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "IngestHasSbomID", ctx, subject, hasSbom)
	ret0, _ := ret[0].(string)
	ret1, _ := ret[1].(error)
	return ret0, ret1
}
...
func (mr *MockBackendMockRecorder) IngestHasSbomID(ctx, subject, hasSbom interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "IngestHasSbomID", reflect.TypeOf((*MockBackend)(nil).IngestHasSbomID), ctx, subject, hasSbom)
}
