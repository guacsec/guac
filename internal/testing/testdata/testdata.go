...
`
	...
	SpdxDeps = []assembler.IsDependencyIngest{
		...
		},
		{
			Pkg: &model.PkgInputSpec{
				Type:      "cpe",
				Namespace: ptrfrom.String("alpine"),
				Name:      "alpine-keys",
				Version:   ptrfrom.String("2.4-r1"),
		...
		},
		{
			Pkg: &model.PkgInputSpec{
				Type:      "cpe",
				Namespace: ptrfrom.String("alpine-baselayout"),
		...
		},
		{
			Pkg: &model.PkgInputSpec{
				Type:      "cpe",
				Namespace: ptrfrom.String("alpine-keys"),
				Name:      "alpine-keys",
				Version:   ptrfrom.String("2.4-r1"),
				Qualifiers: []generated.PackageQualifierInputSpec{
					{Key: "cpe-edition", Value: "ANY"},
		...
		},
		{
			...
			DepPkg: &model.PkgInputSpec{
				Type:      "cpe",
				Namespace: ptrfrom.String("alpine-baselayout-data"),
	...
	SpdxPkgEqual = []assembler.PkgEqualIngest{
		{
			Pkg: &generated.PkgInputSpec{
				Type:      "cpe",
				Namespace: ptrfrom.String("alpine-keys"),
			...
			EqualPkg: &generated.PkgInputSpec{
				...
				Qualifiers: []generated.PackageQualifierInputSpec{
					...
					{Key: "distro", Value: "alpine-3.16.2"},
					{Key: "upstream", Value: "alpine-keys"},
				},
				Subpath: ptrfrom.String(""),
			},
			PkgEqual: &generated.PkgEqualInputSpec{Justification: "spdx package with cpe external reference", Collector: "GUAC"},
		},
		{
			Pkg: &generated.PkgInputSpec{
				Type:      "cpe",
		...
		},
		{
			...
			EqualPkg: &generated.PkgInputSpec{
				...
				Qualifiers: []generated.PackageQualifierInputSpec{
					{Key: "arch", Value: "x86_64"},
					{Key: "distro", Value: "alpine-3.16.2"},
					{Key: "upstream", Value: "alpine-baselayout"},
				},
				Subpath: ptrfrom.String(""),
			},
			PkgEqual: &generated.PkgEqualInputSpec{Justification: "spdx package with cpe external reference", Collector: "GUAC"},
...
var IngestPredicatesCmpOpts = []cmp.Option{
	...
	cmpopts.SortSlices(pkgEqualLess),
}
...
func pkgEqualLess(e1, e2 assembler.PkgEqualIngest) bool {
	return gLess(e1, e2)
}
