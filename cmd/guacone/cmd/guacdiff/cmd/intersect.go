...
var intersectCmd = &cobra.Command{
	Use:   "intersect",
	Short: "Get intersection of two given SBOMS",
	Long:  ``,
...
func init() {
	...
	// .PersistentFlags().StringSlice("slsa", []string{}, "two slsa to find the diff between")
	// rootCmd.PersistentFlags().Bool("uri", false, "input is a URI")
	// rootCmd.PersistentFlags().Bool("purl", false, "input is a pURL")
	// rootCmd.PersistentFlags().Bool("metadata", false, "Intersection of SBOM metadata")
	// rootCmd.PersistentFlags().Bool("inclSoft", false, "Intersection of Included Softwares")
	// rootCmd.PersistentFlags().Bool("inclDeps", false, "Intersection of Included Dependencies")
	// rootCmd.PersistentFlags().Bool("inclOccur", false, "Intersection of Included Occurrences")
	// rootCmd.PersistentFlags().Bool("namespaces", false, "Intersection of Package Namespaces")
}
