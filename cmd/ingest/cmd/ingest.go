...
func validateFlags(user string, pass string, dbAddr string, realm string, natsAddr string, csubAddr string, graphqlEndpoint string, args []string) (options, error) {
	var opts options
	opts.user = user
	opts.pass = pass
	opts.dbAddr = dbAddr
